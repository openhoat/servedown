...
class ServeDown {
  ...
  getTemplate({res, name, defaultContent = 'Empt content'}) {
  ...
  buildExpressRouter() {
    ...
    const middlewares = {
      ...
      theme(req, res, next) {
        ...
        res.locals.compiledTemplate = this.getTemplate({
          res,
          name: 'doc',
...
<body><%= body %></body>
      ...
      searchForm(req, res) {
        res.locals.searchFormCompiledTemplate = this.getTemplate({
          res,
          name: 'searchform',
      ...
      home(req, res) {
        res.locals.indexCompiledTemplate = this.getTemplate({
          res,
          name: 'index',
